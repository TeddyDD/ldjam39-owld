...
func enter(fromStateID=null, fromTransitionID=null, inArg0=null,inArg1=null, inArg2=null):
	logicRoot.get_node("say").say("")
	logicRoot.get_node("SamplePlayer2D").play("owl-splash")
	get_node("/root/game/game start").play("game over")
	get_node("/root/game/win timer").stop()
